...
- [`Snowflake.RunSQLAction`](https://github.com/marcelinojackson-org/Snowflake.RunSQLAction) – run SQL and return CSV or artifacts.
- [`Snowflake.CortexAI.SearchAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.SearchAction) – semantic search over Snowflake data.
- [`Snowflake.CortexAI.AnalystAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.AnalystAction) – ask semantic models/views in natural language.
- [`Snowflake.CortexAI.AgentAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.AgentAction) – talk to a Cortex Agent and capture the full reasoning trace.
...
That’s exactly what [`Snowflake.RunSQLAction`](https://github.com/marcelinojackson-org/Snowflake.RunSQLAction) does.
...
[`Snowflake.CortexAI.SearchAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.SearchAction) is my retrieval layer: I use it when I want the top‑N relevant hits to feed into later steps.
...
In the daily report, I narrow the search to “at‑risk” orders and include scores:
...
[`Snowflake.CortexAI.AnalystAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.AnalystAction) wraps that into a GitHub Action, so I can ask business questions like “What were total sales by nation in 1995?” from CI.

### Natural‑language questions on semantic models

Here’s a basic call against a semantic model:
...
In real workflows, I want both the generated SQL *and* the answer, so I can review and/or store them:
...
Finally, I use [`Snowflake.CortexAI.AgentAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.AgentAction) to talk to a full Cortex Agent.
...
For a single manager‑style question:
...
For more complex flows, I specify which tools the agent can use and inspect the full trace:
...
- [`Snowflake.RunSQLAction`](https://github.com/marcelinojackson-org/Snowflake.RunSQLAction)
- [`Snowflake.CortexAI.SearchAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.SearchAction)
- [`Snowflake.CortexAI.AnalystAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.AnalystAction)
- [`Snowflake.CortexAI.AgentAction`](https://github.com/marcelinojackson-org/Snowflake.CortexAI.AgentAction)
